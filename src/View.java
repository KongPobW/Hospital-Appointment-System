...
public class View extends JFrame {
	...
	public View(JTextField username, JPasswordField password) {
		...
		imgView.setIcon(new ImageIcon("GUI/View.jpg"));
		view.add(imgView);
	}
	...
	private void createTable(JTextField username) {
		...
		String sqlSelect = "SELECT * FROM Appointment INNER JOIN Department ON Appointment.idDept = Department.idDept WHERE UserName = " + "'" + username.getText() + "'";
