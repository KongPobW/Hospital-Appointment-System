...
public class SignIn extends JFrame {
	...
	public SignIn() {
		...
		imgSignIn.setIcon(new ImageIcon("GUI/Sign In.jpg"));
	...
	private void checkSignIn() {
		...
		String sqlSelect = "SELECT UserName, PatPass FROM Patient WHERE UserName = " + "'" + username.getText() + "'" + " AND PatPass = " + "'" + pass_input + "'";
