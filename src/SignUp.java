...
public class SignUp extends JFrame {
	...
	public SignUp() {
		...
		imgSignUp.setIcon(new ImageIcon("GUI/Sign Up.jpg"));
	...
	private void createAccount() {
		...
		try {
			...
			if (!username.getText().equals("") && !name.getText().equals("") && !pass_input.equals("")) {
				...
				String sqlInsert = "INSERT INTO Patient (`UserName`, `PatPass`, `PatName`) VALUES ('" + username.getText() + "', '" + pass_input + "', '" + name.getText() + "')";
