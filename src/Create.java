...
public class Create extends JFrame {
	...
	public Create(JTextField username, JPasswordField password) {
		...
		imgCreate.setIcon(new ImageIcon("GUI/Create.jpg"));
	...
	private void createAppointment(JTextField username, JPasswordField password) {
		...
		try {
			...
			String sqlSelect = "SELECT * FROM Department WHERE Dname = '" + dept.getSelectedItem().toString() + "'";
			...
			String sqlInsert = "INSERT INTO Appointment (`Date`, `Time`, `UserName`, `Pnumber`, `idDept`) VALUES ('" + date.getText() + "', '" + time.getText() + "', '" + username.getText() + "', '" + phone.getText() + "', " + idDept + ")";
